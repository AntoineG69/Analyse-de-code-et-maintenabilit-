...
public class ShuttleApplication extends DaggerApplication {
    ...
    public UserSelectedArtwork getArtwork(String key) {
        return userSelectedArtwork.get(key);
    }

    public void setArtwork(String key, UserSelectedArtwork artwork) {
        userSelectedArtwork.put(key, artwork);
    }

    public Set<String> getArtworkKeys() {
        return userSelectedArtwork.keySet();
    }

    public Map<String, UserSelectedArtwork> getUserSelectedArtworkUnmodifiable() {

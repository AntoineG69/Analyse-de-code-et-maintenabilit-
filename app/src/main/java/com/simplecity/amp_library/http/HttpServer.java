                ...
                try {
                    ...
                    if (start <= end) {
                        ...
                        if (skippedBytes != start) {
                            contentLength -= (start - skippedBytes); // Adjust content length based on actual skipped bytes
                        }
                        ...
                        response.addHeader("Content-Range", "bytes " + skippedBytes + "-" + end + "/" + fileLength);

...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        // Adjust the condition to check for the manual pause state as well
        if (!isPlaying() && !playbackManager.willResumePlayback() || isManuallyPaused) {
            analyticsManager.dropBreadcrumb(TAG, "stopSelf() called");
            stopSelf();
        }
    ...
    public void pausePlaybackManually() {

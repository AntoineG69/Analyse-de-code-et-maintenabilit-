...
public class DrawerParent implements Parent<DrawerChild> {
    ...
    static class ParentHolder extends ParentViewHolder {
        ...
        public void onExpansionToggled(boolean expanded) {
            ...
            // Determine the starting angle for the rotation animation.
            float startAngle = expandableIcon.getRotation();
            float endAngle = expanded ? 180f : 0f; // Rotate to 180 degrees if expanded, else return to 0 degrees.

            objectAnimator = ObjectAnimator.ofFloat(expandableIcon, View.ROTATION, startAngle, endAngle);
